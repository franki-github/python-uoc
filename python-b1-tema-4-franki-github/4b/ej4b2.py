...
def average_score_ram(scores_dict):
    ...
    for score in scores_dict.values():
        average_score_list = [score for score in scores_dict.values()]
    return sum(average_score_list) / len(average_score_list)
    pass
...
def average_score_heap(scores_dict):
    ...
    for score in scores_dict.values():
        ...
        #corregimos el error dividien entre el numero de elementos
