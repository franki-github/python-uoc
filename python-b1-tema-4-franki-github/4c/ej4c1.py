...
class Student(Person):
    ...
    def __init__(self, name, age, major):
        ...
        #asignamos el major a la clase hija
        self.major = major
        pass
    ...
    def describe(self):
        ...
        #accedemos a la funcion de la clase padre y la guardamos en una variable
        #la llamamos con self para que use los atributos de la clase hija
        base_description = super().describe()
        return f"{base_description} Studies {self.major}."
