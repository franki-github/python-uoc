...
def calculate_max_and_min(list_numbers):
    ...
    try:
        ...
        if any(isinstance(i, str) for i in list_numbers):
            raise TypeError("La lista no puede contener cadenas de texto")
...
print("\nResult: ", calculate_max_and_min(['Hello', 1, 5, -20, 55.5]))
