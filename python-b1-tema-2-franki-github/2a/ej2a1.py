...
shopping_list = [10, 449, 33, 44, 188, 640]
print("while: ", sum_even_numbers_in_list_while(shopping_list))
print("for: ", sum_even_numbers_in_list_for(shopping_list))
print("do while: ", sum_even_numbers_in_list_do_while(shopping_list))
