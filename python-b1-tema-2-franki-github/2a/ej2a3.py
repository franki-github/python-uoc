...
def main(list_students, new_student_by_value, new_student_by_reference):
    ...
    print("Student list by value", add_student_by_value(list_students.copy(), new_student_by_value))
    print("Student list by reference", add_student_by_reference(list_students, new_student_by_reference))
    print("Original student list", list_students)  # Check if the original list has changed
    pass
